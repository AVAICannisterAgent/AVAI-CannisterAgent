...
// Handles IC canister analysis and management
...
actor CanisterAgent {
    ...
    // IC canister management endpoints
    private let IC_REPLICA_ENDPOINT = "http://localhost:4943";
    ...
    public query func getCanisterCapabilities() : async [Types.AgentCapability] {
        [
            #CodeAnalysis,
            #SecurityScanning,
            #ReportGeneration,
    ...
    public func getAgentStatus() : async Types.AgentStatus {
        let capabilities = await getCanisterCapabilities();
        {
            id = "canister-agent";
            name = "IC Canister Analysis Agent";
            isActive = true;
